...
class Settings(BaseSettings):
    ...
    CAMERA_HANDOFF_DETAILS: Dict[Tuple[str, str], CameraHandoffDetailConfig] = {
        ...
        ("campus", "c02"): CameraHandoffDetailConfig(
            exit_rules=[
        ...
        ("factory", "c09"): CameraHandoffDetailConfig(
            exit_rules=[
                ...
                ExitRuleModel(source_exit_quadrant=QuadrantName("lower_right"), target_cam_id=CameraID("c13"), target_entry_area="upper right", notes="wait; overlap c13/c16 possible"),
            ],
